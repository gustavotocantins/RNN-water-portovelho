...
for neuronio in neuronios_conj:
    for epoca in epocas:
        for lr in learning_rate:
            ...
            #Treinamento
            model.fit(enttreino, saida_des_treino, epochs=epoca, batch_size=2, verbose=True)
            ...
            if ermse < result:
                ...
                result = ermse
                salvar_modelo(f"rmse-{ermse}-n{neuronio}-e{epoca}-t{lr}")
            else:
                pass
